...
public function run()
    {
        ...
        DB::table('usuarios')->insert(['nome' => 'Coordenador', 'cpf' => '12345678911', 'password' => $senhac, 'remember_token' =>$remember_token, 'email' => 'Coordenador@ufrpe.com', 'tipousuario_id' => 2, 'curso_id' => 1]);

        //Criação de professor

        DB::table('usuarios')->insert(['nome' => 'Professor', 'cpf' => '02345678913', 'password' => $senhap, 'remember_token' =>$remember_token, 'email' => 'Professor@ufrpe.com', 'tipousuario_id' => 3, 'curso_id' => 1]);
