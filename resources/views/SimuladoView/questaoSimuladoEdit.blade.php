			...
			<div class="card row">
				...
				<div class="card-body">
					...
					<div class="col-md-12 mt-4 text-center">
						...
						@endif
                        <button onclick="atLeastOneRadio()" id="confirmar-btn" type="submit" class="btn btn-success pull-center" data-container="body" data-toggle="popover" data-placement="right" data-content="Selecione uma alternativa para prosseguir.">Salvar resposta</button>
