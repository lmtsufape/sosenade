...
@section('content')
    ...
    <form action="{{route('update_answ',['id'=>$resposta->id])}}" method="post">
        ...
        <div class="container">
            <div class="shadow p-3 bg-white" style="border-radius: 10px">
                <div class="row"
                    ...
                    <div class="col-sm">
                        <h1 style="margin-left: 15px; margin-top: 15px; margin-bottom: 25px">Revisar Resposta</h1>
                    </div>
                </div>
                <div class="card row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="list-group container">
                            ...
                            <input type="radio" name="alternativa" id="radioa" value="0" required autofocus
                                   @if($resposta->alternativa_questao == "0") checked @endif />
                            ...
                            <input type="radio" name="alternativa" id="radiob" value="1"
                                   @if($resposta->alternativa_questao == "1") checked @endif />
                            ...
                            <input type="radio" name="alternativa" id="radioc" value="2"
                                   @if($resposta->alternativa_questao == "2") checked @endif />
                            ...
                            <input type="radio" name="alternativa" id="radiod" value="3"
                                   @if($resposta->alternativa_questao == "3") checked @endif />
                            ...
                            <input type="radio" name="alternativa" id="radioe" value="4"
                                   @if($resposta->alternativa_questao == "4") checked @endif />
                            <label class="list-group-item" for="radioe">E
                                - {!! nl2br($questao['alternativa_e'])!!}</label>
                        </div>
                        <div class="form-group col-md-12 text-center">
                            <br><a class="btn btn-primary mr-3"
                                   href="{{route('list_edit_answ',['id'=>$simulado->id])}}"> Voltar </a>
