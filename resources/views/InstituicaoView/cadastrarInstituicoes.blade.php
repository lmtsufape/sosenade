...
@section('content')
    <div class="shadow p-3 bg-white" style="border-radius: 10px; width: 80%; margin-left: auto; margin-right: auto">
        ...
        <form action="{{ route('add_instituicao') }}" method="post">
                ...
                <div class="form-row col-md-12 justify-content-center">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" id="cnpj" name="cnpj" placeholder="00.000.000/0000-00"
                               ...
                               value="{{ old('cnpj') }}" required autofocus>
                        @if ($errors->has('cnpj'))
                            <span class="invalid-feedback" role="alert">
							{{$errors->first('cnpj')}}
						</span>
            ...
            <div class="row" style="margin-left: 60%; margin-top: -15px">
                <div class="text-center my-3" id="btn_cadastrar">
                    <button type="submit" name="cadastrar" class="btn btn-primary" style="width: 200px">Cadastrar Instituição</button>
                </div>
            </div>
        </form>
    </div>
