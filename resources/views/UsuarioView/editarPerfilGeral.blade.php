    ...
    <div class="shadow p-3 bg-white text-center" style="border-radius: 10px">
        ...
        <div class="card" id="body-tabs">
            @if(Auth::user()->id == $usuario->id)
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link {{Session::has('senha') ? '' : 'active'}}" id="alterar-tab"
                               data-toggle="tab" href="#alterar" role="tab" aria-controls="alterar"
                               aria-selected="true">Alterar Dados</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{Session::has('senha') ? 'active' : ''}}" id="importar-tab"
                               data-toggle="tab" href="#importar" role="tab" aria-controls="importar"
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade {{Session::has('senha') ? '' : 'show active'}}" id="alterar" role="tabpanel"
                     aria-labelledby="alterar-tab">
                ...
                <div class="tab-pane fade {{Session::has('senha') ? 'show active' : ''}}" id="importar" role="tabpanel"
                     aria-labelledby="importar-tab">
                    <div class="list-group list-group-flush">
                        <br>
